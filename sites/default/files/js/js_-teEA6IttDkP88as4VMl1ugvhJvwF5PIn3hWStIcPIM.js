...
const task = (kay) => {
  ...
  .then(res => res.json())
  .then(properties => {
    document.getElementById("answer").innerHTML = properties
  })
...
// document.getElementById("answer").innerHTML = task(kay)
...
// console.log(result);
  ...
  // .catch((err) =>{console.log("jakis blad", err);})
